                    ...
                    <div className="col-lg-7 pl-0">
                        {(() => {
                            ...
                            if (Object.keys(categories).length > 0) {
                                    ...
                                    <div className="tab-content" id="myTabContent">
                                                    ...
                                                    return (
                                                        <div key={index} className={"tab-pane fade ml-3 " + (((!activeTab && index == 0) || (activeTab == thisCategory.id)) ? "show active" : "")} id={"tab_" + tab_id} role="tabpanel" aria-labelledby="home-tab">
                                                            ...
                                                            <p className="sub_title">
                                                                {typeof thisCategory.items !== 'undefined' ? thisCategory.name : ''}
                                                            </p>
                                        ...
                                        <div className="more_input_box mt-3 ml-3">
                                            <div className="form-group">
                                                <label>Search and add other items</label>
                                            ...
                                            <div className="form-group">
                                                <label>If you dont find your item, add those manually in comma separated</label>
                                                <textarea
                                ...
                                return (
                                    <div className="col-l2 ml-3 pl-3 pt-3">
                                        <p className=''>
