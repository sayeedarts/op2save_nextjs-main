                                ...
                                if (removal_services && (removal_services).length > 0) {
                                    return (
                                        (removal_services).map((service, key) => {
                                            if ((service.display_type === 'both' || service.display_type === 'page')) {
                                                return (
                                                    <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4 mt-2 pt-2" key={key}>
                                                        <div className="blog-post rounded">
                                                            <div className="blog-img d-block overflow-hidden position-relative">
                                                                <Link href={`/${service.slug}`} passHref>
                                                                    <Image src={service.image} className='img-fluid rounded-top link' height={'70%'} width={'100%'} layout='responsive' alt={service.title} />
                                                                </Link>
